...
/**
 * A static factory for creating instances of {@link Date} instances using a
 * readable fluent syntax. All dates are created at midday. To create
 * {@link Date} instances for a specific time use {@link FluentDateTime}.
 * </p>
 * For example:
 *
 * <pre>
...
public abstract class FluentDate {
	...
	/**
	 * Create a {@link Date} instance for midday on the given date in January in
	 * the given year
	...
	/**
	 * Create a {@link Date} instance for midday on the given date in February
	 * in the given year
	 * @param date the day of the month.
	 * @param year the year.
	 */
	...
	/**
	 * Create a {@link Date} instance for midday on the given date in March in
	 * the given year
	 * @param date the day of the month.
	 * @param year the year.
	 */
	...
	/**
	 * Create a {@link Date} instance for midday on the given date in April in
	 * the given year
	 * @param date the day of the month.
	 * @param year the year.
	 */
	...
	/**
	 * Create a {@link Date} instance for midday on the given date in May in the
	 * given year
	 * @param date the day of the month.
	 * @param year the year.
	 */
	...
	/**
	 * Create a {@link Date} instance for midday on the given date in June in
	 * the given year
	 * @param date the day of the month.
	 * @param year the year.
	 */
	...
	/**
	 * Create a {@link Date} instance for midday on the given date in July in
	 * the given year
	 * @param date the day of the month.
	 * @param year the year.
	 */
	...
	/**
	 * Create a {@link Date} instance for midday on the given date in August in
	 * the given year
	 * @param date the day of the month.
	 * @param year the year.
	 */
	...
	/**
	 * Create a {@link Date} instance for midday on the given date in September
	 * in the given year
	 * @param date the day of the month.
	 * @param year the year.
	 */
	...
	/**
	 * Create a {@link Date} instance for midday on the given date in October in
	 * the given year
	 * @param date the day of the month.
	 * @param year the year.
	 */
	...
	/**
	 * Create a {@link Date} instance for midday on the given date in November
	 * in the given year
	 * @param date the day of the month.
	 * @param year the year.
	 */
	...
	/**
	 * Create a {@link Date} instance for midday on the given date in December
	 * in the given year
	 * @param date the day of the month.
	 * @param year the year.
	 */
